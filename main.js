...
function init() {
    ...
    let controls = {
        ...
        addSphere: function() {
            ...
            var sphereSegments = 32; // Número de segmentos da esfera
        ...
        addCone: function() {
            var coneRadius = Math.random() * 3 + 1; // Raio aleatório entre 1 e 4
            var coneHeight = Math.random() * 10 + 5; // Altura aleatória entre 5 e 15
            var coneSegments = 32; // Número de segmentos do cone
            var coneGeometry = new THREE.ConeGeometry(coneRadius, coneHeight, coneSegments);
